...
const initialState = {
    ...
    dbTopScorer: null, dbWinnerTeam: null, curTopScorerChoice: null, curWinnerTeamChoice: null, dbScore: [], currentScore: []
};
...
const betSlice = createSlice({
    ...
    reducers: {
        load(state, action) {
            action.payload.forEach((bet) => state[bet.type] = bet.data);
        },
